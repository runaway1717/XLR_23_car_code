...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA2     ------> ADC2_IN2
    */
    HAL_GPIO_DeInit(GPIOC, Damper1_Pin|Damper2_Pin);

    HAL_GPIO_DeInit(LV_Batt_GPIO_Port, LV_Batt_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PF9     ------> ADC3_IN7
    */
    HAL_GPIO_DeInit(GPIOF, Motor1_Pin|Motor2_Pin|IR_OUT_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(TP2_SCL_GPIO_Port, TP2_SCL_Pin);

    HAL_GPIO_DeInit(TP2_SDA_GPIO_Port, TP2_SDA_Pin);
